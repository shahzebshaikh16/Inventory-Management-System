...
class BillClass:
    def __init__(self,root):
        ...
        BTitle=Label(billFrame,text="Customer Bill Area",font=("goudy old style",20,"bold"),bg="darkorange",fg="white").pack(side=TOP,fill=X)
        ...
        self.lbl_amt=Label(billMenuFrame,text="Bill Amount\n[0]",font=("goudy old style",15,"bold"),bg="#3f51b5",fg="white",bd=3)
        self.lbl_amt.place(x=2,y=5,width=120,height=70)

        self.lbl_discount=Label(billMenuFrame,text="Discount\n[5%]",font=("goudy old style",15,"bold"),bg="#8bc34a",fg="white",bd=3)
        self.lbl_discount.place(x=124,y=5,width=120,height=70)

        self.lbl_net_pay=Label(billMenuFrame,text="Net Pay\n[0]",font=("goudy old style",15,"bold"),bg="#607d8b",fg="white",bd=3)
        self.lbl_net_pay.place(x=246,y=5,width=160,height=70)

        btn_print=Button(billMenuFrame,text="Print",command=self.print_bill,cursor='hand2',font=("goudy old style",15,"bold"),bg="green",fg="white",bd=3)
        btn_print.place(x=2,y=80,width=120,height=50)

        btn_clear_all=Button(billMenuFrame,text="Clear All",command=self.clear_all,cursor='hand2',font=("goudy old style",15,"bold"),bg="gray",fg="white",bd=3)
        btn_clear_all.place(x=124,y=80,width=120,height=50)

        btn_generate=Button(billMenuFrame,text="Generate/Save Bill",command=self.generate_bill,cursor='hand2',font=("goudy old style",15,"bold"),bg="#009688",fg="white",bd=3)
        btn_generate.place(x=246,y=80,width=160,height=50)

        #footer
        footer=Label(self.root,text="IMS-Inventory Management System | Developed By Shahzeb\nFor any Technical Issue contact: 895xxxx786",font=("times new roman",11),bg="#4d636d",fg="white").pack(side=BOTTOM,fill=X)
    ...
    def bill_top(self):
        ...
        bill_top_temp=f'''
\t\tXYZ-Inventory
\t Phone No. 9758****** , Bangalore-560001
{str("="*47)}
